...
require 'header.php'
?>
    <div class="container col-sm-9" style="background: #d6d8db">
            ...
            <div class="row justify-content-center p-4">
                    <div class="card-img col-sm-3 pb-5 m-sm-5">
                        <a href="adventure.php">
                            <div class="box">
                                <img class="w-100" src="image/adventure.svg">
                                <div class="text">
                                    <h1>SAPEK ADVENTURE</h1>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="card-img col-sm-3 pb-5 m-sm-5">
                        <img class="w-100" src="image/trip.svg">
                    </div>
                    <div class="card-img col-sm-3 pb-5 m-sm-5">
                        <img class="w-100" src="image/celoteh.svg">
                    </div>
                    <div class="card-img col-sm-3 pb-5 m-sm-5">
                        <img class="w-100" src="image/kenangan.svg">
                    </div>
                    <div class="card-img col-sm-3 pb-5 m-sm-5">
                        <img class="w-100" src="image/outdoor.svg">
                    </div>
                    <div class="card-img col-sm-3 pb-5 m-sm-5">
                        <img class="w-100" src="image/agsn.svg">
                    </div>
            </div>
        </div>
    </div>
