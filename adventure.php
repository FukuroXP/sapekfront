...
<div class="container bg-light col-sm-9 pb-sm-3">
<hr>
    <div class="container col-sm-12">
        ...
        <hr class="mt-sm-5" style="border-width: 5px; border-color: #2f9f00;">
    </div>
            ...
            for ($x = 1; $x <= 10; $x++){
                ...
                <div class="card col-sm-2 text-center m-3">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="itembuy.php" class="btn btn-sm w-100 btn-success">Beli</a>
                        <br>
                    </div>
                </div>
                <?php
